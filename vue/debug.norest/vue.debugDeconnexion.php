...
<!-- - - - - - - - - - - - -  FORMULAIRE HTML - - - - - - - - - - - -->
<form method="post" action="" name="debug_deconnexion">
	...
	<tr>
		<td><input type="button" name="buttonDeconnexion" value="Deconnecter" 
		  onclick="form_submit('<?php echo $this->c->forgeUriAction('buttonDeconnecter',array());?>',-1,'')">
		</td>		
	</tr>
	</table>
</form>	
